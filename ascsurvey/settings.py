"""
Django settings for ascsurvey project.
...
WSGI_APPLICATION = 'ascsurvey.wsgi.application'
...
LOGIN_REDIRECT_URL = '/ascsurvey/'
LOGOUT_REDIRECT_URL = '/ascsurvey/'
